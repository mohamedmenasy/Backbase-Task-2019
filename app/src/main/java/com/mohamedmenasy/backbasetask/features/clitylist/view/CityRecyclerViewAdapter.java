...
public class CityRecyclerViewAdapter
    extends RecyclerView.Adapter<CityRecyclerViewAdapter.ViewHolder> {
  ...
  public CityRecyclerViewAdapter(List<City> items,
      OnListClickInteractionListener onListClickInteractionListener,
      OnInfoClickInteractionListener onInfoClickInteractionListener) {
    mValues = items;
  ...
  public void onBindViewHolder(final ViewHolder holder, int position) {
    ...
    holder.mTitleTV.setText(
        mValues.get(position).getName() + ", " + mValues.get(position).getCountry());
    holder.mSubTitleTV.setText(
        mValues.get(position).getCoord().getLat() + ", " + mValues.get(position)
            .getCoord()
            .getLon());
